...
class GongzhongViewModel : ViewModel() {
    ...
    fun  getWxArticle(id:Int,page:Int) :MutableLiveData<WxArticle>{
        gongzhongModel.getWxArticle(id,page,object :Callback<Result<WxArticle>>{
            override fun onFailure(call: Call<Result<WxArticle>>?, t: Throwable?) {
                TODO("not implemented") //To change body of created functions use File | Settings | File Templates.
            }

            override fun onResponse(call: Call<Result<WxArticle>>?, response: Response<Result<WxArticle>>?) {
